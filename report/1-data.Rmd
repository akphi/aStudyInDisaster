...
summary(titanic$number_of_parents_and_children)
summary(titanic$number_of_siblings_and_spouses)
...
```{r, warning=FALSE, message=FALSE, echo=FALSE, fig.width = 14, fig.height=14, eval=FALSE}
